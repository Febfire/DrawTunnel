...
namespace UI.Jig
{
    public class SquareTunnelJig : EntityJig
    {
        List<Point3d> mPoints;
        DynamicDimensionDataCollection m_dims;
        int mPromptCounter;
        public SquareTunnelJig(Point3d firstPt) : base(new SquareTunnel())
        {
        ...
        {
            ((SquareTunnel)Entity).BasePoints = mPoints;
        ...
        {
            //SquareTunnel Tunnel = (SquareTunnel)Entity;
